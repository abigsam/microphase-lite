...
##--------------------------------------------------------------------------------------+-----------+---------+
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN L16} [get_ports  {GPIO2_0P}];    # GPIO2_0P  | JP2[1]  |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN L17} [get_ports  {GPIO2_0N}];    # GPIO2_0N  | JP2[2]  |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN H15} [get_ports  {GPIO2_1P}];    # GPIO2_1P  | JP2[3]  |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN G15} [get_ports  {GPIO2_1N}];    # GPIO2_1N  | JP2[4]  |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN F16} [get_ports  {GPIO2_2P}];    # GPIO2_2P  | JP2[5]  |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN E18} [get_ports  {GPIO2_3P}];    # GPIO2_3P  | JP2[7]  |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN F17} [get_ports  {GPIO2_2N}];    # GPIO2_2N  | JP2[6]  |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN E19} [get_ports  {GPIO2_3N}];    # GPIO2_3N  | JP2[8]  |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN B19} [get_ports  {GPIO2_4P}];    # GPIO2_4P  | JP2[9]  |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN A20} [get_ports  {GPIO2_4N}];    # GPIO2_4N  | JP2[10] |
##                                                                                      # VCC_5V    | JP2[11] |
##                                                                                      # GND       | JP2[12] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN D19} [get_ports  {GPIO2_5P}];    # GPIO2_5P  | JP2[13] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN D20} [get_ports  {GPIO2_5N}];    # GPIO2_5N  | JP2[14] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN E17} [get_ports  {GPIO2_6P}];    # GPIO2_6P  | JP2[15] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN D18} [get_ports  {GPIO2_6N}];    # GPIO2_6N  | JP2[16] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN H16} [get_ports  {GPIO2_7P}];    # GPIO2_7P  | JP2[17] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN H17} [get_ports  {GPIO2_7N}];    # GPIO2_7N  | JP2[18] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN G19} [get_ports  {GPIO2_8P}];    # GPIO2_8P  | JP2[19] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN G20} [get_ports  {GPIO2_8N}];    # GPIO2_8N  | JP2[20] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN J18} [get_ports  {GPIO2_9P}];    # GPIO2_9P  | JP2[21] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN H18} [get_ports  {GPIO2_9N}];    # GPIO2_9N  | JP2[22] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN K16} [get_ports {GPIO2_10P}];    # GPIO2_10P | JP2[23] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN J16} [get_ports {GPIO2_10N}];    # GPIO2_10N | JP2[24] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN C20} [get_ports {GPIO2_11P}];    # GPIO2_11P | JP2[25] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN B20} [get_ports {GPIO2_11N}];    # GPIO2_11N | JP2[26] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN G17} [get_ports {GPIO2_12P}];    # GPIO2_12P | JP2[27] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN G18} [get_ports {GPIO2_12N}];    # GPIO2_12N | JP2[28] |
##                                                                                      # VCC_3V3   | JP2[29] |
##                                                                                      # GND       | JP2[30] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN L19} [get_ports {GPIO2_13P}];    # GPIO2_13P | JP2[31] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN L20} [get_ports {GPIO2_13N}];    # GPIO2_13N | JP2[32] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN F19} [get_ports {GPIO2_14P}];    # GPIO2_14P | JP2[33] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN F20} [get_ports {GPIO2_14N}];    # GPIO2_14N | JP2[34] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN M19} [get_ports {GPIO2_15P}];    # GPIO2_15P | JP2[35] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN M20} [get_ports {GPIO2_15N}];    # GPIO2_15N | JP2[36] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN K19} [get_ports {GPIO2_16P}];    # GPIO2_16P | JP2[37] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN J19} [get_ports {GPIO2_16N}];    # GPIO2_16N | JP2[38] |
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN J20} [get_ports {GPIO2_17P}];    # GPIO2_17P | JP2[39] | Shared with ETH_nRST
# set_property -dict { IOSTANDARD LVCMOS33 PACKAGE_PIN H20} [get_ports {GPIO2_17N}];    # GPIO2_17N | JP2[40] |
