...
# #JP2 (BANK35 3V3)
# set_property -dict { IOSTANDARD LVCMOS33 } [get_ports -filter "J2*"];
...
# set_property PACKAGE_PIN J20 [get_ports { J2P[17] }];
# #
...
# #HDMI
# set_property -dict { IOSTANDARD LVCMOS33 } [get_ports -filter "HDMI*"];
...
# set_property -dict { IOSTANDARD LVCMOS33 } [get_ports -filter "ETH*"];
